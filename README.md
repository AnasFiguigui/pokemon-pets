...
- **Achievements & Badges** — 54 gym badges to earn, each tied to an achievement, from "feed your first candy" to "own all 8 Eevee evolutions". Locked badges show live progress bars; unlocking grants gold. Open **Badges** from the Actions menu.
- **Daily Reward Calendar** — A monthly login calendar in the Badges menu: claim today's reward (gold, potions, candy, stones) each day you open VS Code. Miss a day and it stays missed — a full month earns a special badge. Resets every month.
