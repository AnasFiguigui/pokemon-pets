...
export const Consumables: Consumable[] = [
    ...
    { id: 'razz_berry', name: 'Razz Berry', price: 50, description: 'A tangy berry that restores HP and stamina.', category: 'food', restoreHp: 10, restoreStamina: 20, friendshipGain: 1 },
    { id: 'maranga_berry', name: 'Maranga Berry', price: 100, description: 'A rich berry that greatly restores HP and stamina.', category: 'food', restoreHp: 0, restoreStamina: 50, friendshipGain: 4 },
...
export const PlantTypes: PlantType[] = [
    ...
    {
        id: 'razz_berry_plant', name: 'Razz Berry Seed', price: 400, description: 'Grows Razz Berries. Regrows after each harvest!', producesId: 'razz_berry', harvestType: 'repeatable', growthHours: [0.1, 0.2, 0.2, 0.3, 0.2], minFruits: 1, maxFruits: 3, size: [16, 32], spriteOffset: [0, 32], phaseStep: [16, 0],
    },
    {
        id: 'maranga_berry_plant', name: 'Maranga Berry Seed', price: 500, description: 'Grows Maranga Berries. One harvest only!', producesId: 'maranga_berry', harvestType: 'single', growthHours: [0.2, 0.4, 0.4, 0.6, 0.4], minFruits: 2, maxFruits: 5, size: [16, 32], spriteOffset: [0, 64], phaseStep: [16, 0],
    },
];
...
export const Pokemons: { [generation: string]: PokemonSpecies[] } = {
    'generation 1': [
        ...
        },
        {
            name: 'Gastly',
            forms: [
                { name: 'Gastly', sprite: 'gastly', spriteSize: 32, candyCost: 0 },
                { name: 'Haunter', sprite: 'haunter', spriteSize: 32, candyCost: 25 },
                { name: 'Gengar', sprite: 'gengar', spriteSize: 32, candyCost: 50 },
            ],
        },
    ],
    ...
    'generation 2': [
        {
            ...
            forms: [
                ...
                { name: 'Bayleef', sprite: 'bayleef', spriteSize: 48, candyCost: 10 },
                { name: 'Meganium', sprite: 'meganium', spriteSize: 32, candyCost: 25 },
            ],
        },
        {
            name: 'Cyndaquil',
            forms: [
                ...
                { name: 'Typhlosion', sprite: 'typhlosion', spriteSize: 32, candyCost: 25 },
            ],
        },
        {
            name: 'Totodile',
    ...
    'generation 3': [
        ...
        { name: 'Torchic', forms: [{ name: 'Torchic', sprite: 'torchic', spriteSize: 32, candyCost: 0 }, { name: 'Combusken', sprite: 'combusken', spriteSize: 32, candyCost: 10 }, { name: 'Blaziken', sprite: 'blaziken', spriteSize: 32, candyCost: 25 }] },
        { name: 'Mudkip', forms: [{ name: 'Mudkip', sprite: 'mudkip', spriteSize: 32, candyCost: 0 }, { name: 'Marshtomp', sprite: 'marshtomp', spriteSize: 32, candyCost: 10 }, { name: 'Swampert', sprite: 'swampert', spriteSize: 32, candyCost: 25 }] },
    ],
    ...
    'generation 5': [
        ...
        { name: 'Tepig', forms: [{ name: 'Tepig', sprite: 'tepig', spriteSize: 32, candyCost: 0 }, { name: 'Pignite', sprite: 'pignite', spriteSize: 32, candyCost: 10 }, { name: 'Emboar', sprite: 'emboar', spriteSize: 32, candyCost: 25 }] },
        ...
        { name: 'Zorua', forms: [{ name: 'Zorua', sprite: 'zorua', spriteSize: 32, candyCost: 0 }, { name: 'Zoroark', sprite: 'zoroark', spriteSize: 48, candyCost: 25 }] },
    ],

    // 'generation 6': [
    //     { name: 'Chespin', forms: [{ name: 'Chespin', sprite: 'chespin', spriteSize: 32, candyCost: 0 }, { name: 'Quilladin', sprite: 'quilladin', spriteSize: 32, candyCost: 10 }, { name: 'Chesnaught', sprite: 'chesnaught', spriteSize: 32, candyCost: 25 }] },
    //     { name: 'Fennekin', forms: [{ name: 'Fennekin', sprite: 'fennekin', spriteSize: 32, candyCost: 0 }, { name: 'Braixen', sprite: 'braixen', spriteSize: 32, candyCost: 10 }, { name: 'Delphox', sprite: 'delphox', spriteSize: 32, candyCost: 25 }] },
    //     { name: 'Froakie', forms: [{ name: 'Froakie', sprite: 'froakie', spriteSize: 32, candyCost: 0 }, { name: 'Frogadier', sprite: 'frogadier', spriteSize: 32, candyCost: 10 }, { name: 'Greninja', sprite: 'greninja', spriteSize: 32, candyCost: 25 }] },
    // ],
